...
trait Elastic[JsonR] {
  ...
  /**
    ...
    */
  def index(name: String): Index[JsonR]
  ...
  /**
    ...
    */
  def getMapping(index: String)(implicit sReader: Reader[String, JsonR], ec: ExecutionContext): Future[JsonR]
  ...
  /**
    ...
    */
  def getMappings(index: Seq[String])(implicit sReader: Reader[String, JsonR], ec: ExecutionContext): Future[JsonR]
  ...
  /**
    ...
    * @return IndexOps
    */
  def deleteIndex(name: String)(implicit sReader: Reader[String, JsonR], jsonReader: Reader[JsonR, IndexOps], ec: ExecutionContext): Future[IndexOps]
  ...
  /**
    ...
    * @return IndexOps
    */
  def putMapping[M](name: String, mapping: M)(implicit mWrites: Writer[M, String], sReader: Reader[String, JsonR], jsonReader: Reader[JsonR, IndexOps], ec: ExecutionContext): Future[IndexOps]
  ...
  /**
    ...
    */
  def mget(index: Option[String] = None, request: MGets)(implicit sWriter: Writer[JsonR, String], jsonWriter: Writer[MGets, JsonR], sReader: Reader[String, JsonR], jsonReader: Reader[JsonR, MGetResponse[JsonR]], ec: ExecutionContext): Future[MGetResponse[JsonR]]
  ...
  /**
    ...
    * @return a [[SearchResponse]]
    */
  def aggregation[Q](index: Seq[String], query: Q, from: Option[Int] = None, size: Option[Int] = None, search_type: Option[SearchType] = None, request_cache: Boolean = false, terminate_after: Option[Int] = None, timeout: Option[Int] = None)(implicit qWrites: Writer[Q, String], jsonReader: Reader[String, SearchResponse[JsonR]], sReader: Reader[String, JsonR], ec: ExecutionContext): Future[SearchResponse[JsonR]]
  ...
  /**
    ...
    */
  def scrollPublisher[Q](index: Seq[String] = Seq.empty, query: Q, scroll: String = "1m", size: Int = 20)(implicit qWrites: Writer[Q, String], jsonWriter: Writer[Scroll, JsonR], sWriter: Writer[JsonR, String], sReader: Reader[String, JsonR], jsonReader: Reader[JsonR, SearchResponse[JsonR]], ec: ExecutionContext): Publisher[SearchResponse[JsonR]]
  ...
  /**
    ...
    * @return a [[org.reactivestreams.Publisher]] (see reactive streams) of [[SearchResponse]]
    */
  def scroll[Q](index: Seq[String] = Seq.empty, query: Q, scroll: String = "1m", size: Int = 20)(implicit qWrites: Writer[Q, String], jsonWriter: Writer[Scroll, JsonR], sWriter: Writer[JsonR, String], sReader: Reader[String, JsonR], jsonReader: Reader[JsonR, SearchResponse[JsonR]], ec: ExecutionContext): Source[SearchResponse[JsonR], NotUsed]
  ...
  /**
    ...
    */
  def bulk[D](index: Option[String] = None, publisher: Publisher[Bulk[D]], batchSize: Int)(implicit sWrites: Writer[JsonR, String], docWriter: Writer[D, JsonR], bulkOpWriter: Writer[BulkOpType, JsonR], sReader: Reader[String, JsonR], bReader: Reader[JsonR, BulkResponse[JsonR]], ec: ExecutionContext): Publisher[BulkResponse[JsonR]]
  ...
  /**
    ...
    */
  def bulkFlow[D](index: Option[String] = None, batchSize: Int)(implicit sWrites: Writer[JsonR, String], docWriter: Writer[D, JsonR], bulkOpWriter: Writer[BulkOpType, JsonR], sReader: Reader[String, JsonR], bReader: Reader[JsonR, BulkResponse[JsonR]], ec: ExecutionContext): Flow[Bulk[D], BulkResponse[JsonR], NotUsed]
  ...
  /**
    ...
    */
  def oneBulk[D](index: Option[String] = None, bulk: Seq[Bulk[D]])(implicit sWrites: Writer[JsonR, String], docWriter: Writer[D, JsonR], bulkOpWriter: Writer[BulkOpType, JsonR], sReader: Reader[String, JsonR], bReader: Reader[JsonR, BulkResponse[JsonR]], ec: ExecutionContext): Future[BulkResponse[JsonR]]
...
/**
  ...
  */
case class BulkOpDetail(_index: Option[String], _id: Option[String]) extends ESRequest
...
object Bulk {
  def index[D](index: String, id: String, source: D) = Bulk(BulkOpType(index = Some(BulkOpDetail(Some(index), Some(id)))), Some(source))
  def indexByIndex[D](index: String, source: D) = Bulk(BulkOpType(index = Some(BulkOpDetail(Some(index), None))), Some(source))
  def indexById[D](id: String, source: D) = Bulk(BulkOpType(index = Some(BulkOpDetail(None, Some(id)))), Some(source))
  def index[D](source: D) = Bulk(BulkOpType(index = Some(BulkOpDetail(None, None))), Some(source))
  def update[D](index: String, id: String, source: D) = Bulk(BulkOpType(update = Some(BulkOpDetail(Some(index), Some(id)))), Some(source))
  def updateByIndex[D](index: String, source: D) = Bulk(BulkOpType(update = Some(BulkOpDetail(Some(index), None))), Some(source))
  def updateById[D](id: String, source: D) = Bulk(BulkOpType(update = Some(BulkOpDetail(None, Some(id)))), Some(source))
  def update[D](source: D) = Bulk(BulkOpType(update = Some(BulkOpDetail(None, None))), Some(source))
  def create[D](index: String, id: String, source: D) = Bulk(BulkOpType(create = Some(BulkOpDetail(Some(index), Some(id)))), Some(source))
  def createByIndex[D](index: String, source: D) = Bulk(BulkOpType(create = Some(BulkOpDetail(Some(index), None))), Some(source))
  def createById[D](id: String, source: D) = Bulk(BulkOpType(create = Some(BulkOpDetail(None,Some(id)))), Some(source))
  def create[D](source: D) = Bulk(BulkOpType(create = Some(BulkOpDetail(None, None))), Some(source))
  def delete(index: String, id: String) = Bulk(BulkOpType(delete = Some(BulkOpDetail(Some(index), Some(id)))), None)
  def delete(id: String) = Bulk(BulkOpType(delete = Some(BulkOpDetail(None, Some(id)))), None)
}
...
/**
  ...
  * @param _id    the id of the document
  */
case class MGet(_index: Option[String], _id: String) extends ESRequest
...
/**
  ...
  * @tparam Json the type of the json representation
  */
case class IndexResponse[Json](_shards: Shards[Json], _index: Option[String] = None, _id: Option[String] = None, _version: Option[Int] = None, created: Option[Boolean] = None, found: Option[Boolean] = None) extends ESResponse
...
/**
  ...
  * @tparam Json the type of the json representation
  */
case class GetResponse[Json](_index: String, _id: String, _version: Int, found: Boolean, _source: Json) extends ESResponse {
...
/**
  ...
  * @tparam Json
  */
case class Total[Json](value: Int, relation: String) extends ESResponse
...
/**
  ...
  * @tparam Json
  */
case class Hits[Json](total: Total[Json], max_score: Option[Float], hits: Seq[Hit[Json]]) extends ESResponse
...
/**
  ...
  * @tparam Json
  */
case class BulkResult[Json](_index: String, _id: String, _version: Option[Int], _shards: Option[Shards[Json]], status: Int, error: Option[Json]) extends ESResponse
